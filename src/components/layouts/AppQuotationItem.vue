<template>
    <v-card outlined hover>
        <v-card-text class="py-0">
            <v-row>
                <v-col cols="1" class="text-left caption">#{{position + 1}}</v-col>
                <v-col cols="3" class="text-left caption" v-text="item.name"></v-col>
                <v-col cols="1" class="text-right caption" v-text="item.quantity"></v-col>
                <v-col cols="2" class="text-right caption">{{(item.discounted ? item.discount : "0") | currency("R", 2)}}</v-col>
                <v-col cols="3" class="text-right caption">{{item.cost | currency("R", 2)}}</v-col>
